...
# Carregando dados
load("C:/Users/ma/Desktop/Bullying/Dados e do-file/Dados R/Versão final/Dados após tratar os dados - polinomios e interações.RData")
...
## Estimação PLR por Random forest para matemática
...
# Para liberar espaço na memória, necessário apagar alguns objetos, assim, retira-se
# os de matemática, 
